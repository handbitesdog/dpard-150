...
type TabBarProps = BottomTabBarProps & { miniPlayerTrack: MiniPlayerSlotTrack | null };

export function TabBar({ state, descriptors, navigation, insets, miniPlayerTrack }: TabBarProps) {
  return (
    <View>
